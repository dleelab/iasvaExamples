...
# To make estimation of the hidden factor more challenging, here we ramdomly select 1500 and 1800 genes from each effect size vector and set their effect sizes as 0. That is, 25% and 5% of genes are affected by the known and hidden factors, respectively. 
...
## Corrected Simulation 1 with high correlation btw known and hidden factors with stronger effect sizes
