...
```{r hidden_factor_estimation, eval=TRUE, fig.height=5, fig.width=10}
...
par(mfrow=c(1,3))
corrplot.mixed(cor(hf1.mat), tl.pos="lt")
corrplot.mixed(cor(hf2.mat), tl.pos="lt")
corrplot.mixed(cor(hf3.mat), tl.pos="lt")
```
